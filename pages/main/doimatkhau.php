                            ...
                            <?php
                                    if (isset($_POST['doimatkhau'])){
                                        ...
                                        if(isset($_SESSION['id_ql'])) {
                                            ...
                                            $sql_ql = "SELECT * FROM tbl_quanly WHERE id_ql = '".$id_ql."' AND matkhau ='".$matkhau_cu."' LIMIT 1";
                                            $result_ql = mysqli_query($mysqli, $sql_ql);
                                            $count_ql = mysqli_num_rows($result_ql);

                                            if ($count_ql > 0) {
                                                $sql_update_ql = "UPDATE tbl_quanly SET matkhau ='".$matkhau_moi."' WHERE id_ql = '".$id_ql."'";
