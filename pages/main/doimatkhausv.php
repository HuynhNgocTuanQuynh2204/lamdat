                            ...
                            <?php
                                    if (isset($_POST['doimatkhausv'])){
                                        ...
                                        if(isset($_SESSION['id_sv'])) {
                                            ...
                                            $sql_sv = "SELECT * FROM tbl_sinhvien WHERE id_sv = '".$id_sv."' AND matkhau ='".$matkhau_cu."' LIMIT 1";
                                            $result_sv = mysqli_query($mysqli, $sql_sv);
                                            $count_sv = mysqli_num_rows($result_sv);

                                            if ($count_sv > 0) {
                                                $sql_update_sv = "UPDATE tbl_sinhvien SET matkhau ='".$matkhau_moi."' WHERE id_sv = '".$id_sv."'";
