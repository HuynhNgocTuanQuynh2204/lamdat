    ...
    <div class="main p-3">
        <div class="text-center">
            <div class="text-center">
                ...
                <h6 style="text-align: center; text-transform: uppercase; font-weight: bold;">Khoa sư phạm</h6>
                <div class="container mt-5">
                    <?php
                        $sql_lop = "SELECT DISTINCT lop FROM tbl_sinhvien WHERE khoa = 'Sư phạm' ORDER BY lop DESC";
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <li><a class="dropdown-item"
                                            href="index.php?quanly=supham&lop=<?php echo $row_lop['lop'] ?>"><?php echo $row_lop['lop'] ?></a>
                                    </li>
                                    <?php
                                        }
                                    ?>
