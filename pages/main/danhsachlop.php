    ...
    <div class="main p-3">
        <div class="text-center">
            <div class="text-center">
                ...
                <h6 style="text-align: center; text-transform: uppercase; font-weight: bold;">Khoa công nghệ thông tin
                </h6>
                <div class="container mt-5">
                    <?php
        $sql_lop = "SELECT DISTINCT lop FROM tbl_sinhvien WHERE khoa = 'Công nghệ thông tin' ORDER BY lop DESC";
    ...
    ?>
                    ...
                    ?>
                                    <li><a class="dropdown-item"
                                            href="index.php?quanly=cntt&lop=<?php echo $row_lop['lop'] ?>"><?php echo $row_lop['lop'] ?></a>
                                    </li>
                                    <?php
                        }
                    ?>
                ...
                <div class="header_fixed">
                    ...
                    $i++;
                    if($row['khoa']=='Công nghệ thông tin'){
                    ?>
                            <tr>
                                <td><?php echo $i ?></td>
