        ...
        <div class="text-center">
            <div class="text-center">
                ...
                <div class="container mt-5">
                    <div class="container mt-5">
                        <?php
                            $sql_lop = "SELECT DISTINCT lop FROM tbl_sinhvien WHERE khoa = 'Nông nghiệp' ORDER BY lop DESC";
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <li><a class="dropdown-item"
                                                href="index.php?quanly=nongnghiep&lop=<?php echo $row_lop['lop'] ?>"><?php echo $row_lop['lop'] ?></a>
                                        </li>
                                        <?php
                                            }
                                        ?>
