...
<?php
  $sql = "SELECT * FROM tbl_giangvien  WHERE id_gv = '$_SESSION[id_gv]' ";
...
<div class="main p-3">
    <div class="text-center">
        ...
        <h6 style="text-align: center; text-transform: uppercase; font-weight: bold;">Thông tin giảng viên</h6>
        ...
        ?>
                ...
                <div class="col-12">
                    <button type="submit" class="btn btn-primary" name="capnhapgiangvien">Cập nhập thông tin giảng viên</button>
                </div>
            </form>
        </section>
    </div>
