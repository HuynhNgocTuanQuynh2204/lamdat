            ...
            ?>
                   ...
                   if ($row['trangthai'] == 0) {
                    ...
                    ?>
                            ...
                            <td>
                                <a href="index.php?quanly=chitietphanhoinn&id=<?php echo $row['id_phanhoi'] ?>"
                                    class="btn btn-info">Xem chi tiếtt</a>
                                <br>
                                <?php
                                    if ($row['trangthai'] ==2 ) {
                                    ?>
                                <a href="index.php?quanly=giaiquyetphanhoinn&id=<?php echo $row['id_phanhoi'] ?>"
                                    class="btn btn-success">Giải quyết</a>
                                <?php
                                    }else if($row['trangthai'] == 3){?>
                                <a href="index.php?quanly=giaiquyetphanhoinnxong&id=<?php echo $row['id_phanhoi'] ?>"
