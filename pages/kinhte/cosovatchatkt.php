<?php
$sql_lietke_phanhoi = "SELECT * FROM tbl_cosovatchat,tbl_sinhvien WHERE tbl_cosovatchat.id_sv = tbl_sinhvien.id_sv ORDER BY tbl_cosovatchat.id_csvc DESC";
    ...
    <div class="text-center">
        ...
        <div class="container">
            ...
            while ($row = mysqli_fetch_array($query_lietke_phanhoi)) {
              $i++;
              if ($row['trangthai'] != 0 && $row['trangthai'] != 1 && $row['phongban'] == 3) {
            ?>
                        <tr>
                            <td><?php echo $i ?></td>
                   ...
                   if ($row['trangthai'] == 0) {
                    ...
                    ?>
                            ...
                            <td>
                                <a href="index.php?quanly=chitietcosovatchatcntt&id=<?php echo $row['id_csvc'] ?>"
                                    class="btn btn-info">Xem chi tiếtt</a>
                                <br>
                                <?php
                                    if ($row['trangthai'] ==2 ) {
                                    ?>
                                <a href="index.php?quanly=giaiquyetcsvccntt&id=<?php echo $row['id_csvc'] ?>"
                                    class="btn btn-success">Giải quyết</a>
                                <?php
                                    }else if($row['trangthai'] == 3){?>
                                <a href="index.php?quanly=giaiquyetcsvccnttxong&id=<?php echo $row['id_csvc'] ?>"
