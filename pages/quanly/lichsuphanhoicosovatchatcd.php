...
<div class="main p-3">
    <div class="text-center">
        <h1 style="text-align: center;padding: 10px;">Lịch sử phản hồi chưa duyệt</h1>
        <div class="container">
            ...
            ?>
                    ...
                    ?>
                            ...
                            <td>
                                <a href="index.php?quanly=duyetphanhoicsvc&id=<?php echo $row['id_csvc'] ?>"
                                    class="btn btn-danger ">Duyệt phản hồi</a><br><br>
                                <a href="index.php?quanly=khongduyetcsvc&id=<?php echo $row['id_csvc'] ?>"
