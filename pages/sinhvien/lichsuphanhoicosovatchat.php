        ...
        <div class="container">
            ...
            ?>
                    ...
                    if ($row['trangthai'] == 0) {
                        ...
                        echo "<b style='color: darkblue'>Phản hồi đã giải quyết thành công vui lòng xác nhận <a href='index.php?quanly=xacnhancsvc&id={$row['id_csvc']}'>Xác nhận</a></b>";
                    } else {
                    ...
                    ?>
                            ...
                            <td>
                                <a href="index.php?quanly=guiphanhoicosovatchat&id=<?php echo $row['id_csvc'] ?>"
                                    ...
                                    if ($row['trangthai'] ==0 ){
                                    ?>
                                <a href="index.php?quanly=suacosovatchat&id=<?php echo $row['id_csvc'] ?>"
