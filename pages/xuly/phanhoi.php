...
$now->format('Y-m-d H:i:s');
   ...
   $theloai = $_POST['theloai'];
    ...
    if(isset($_POST['phanhoi'])){
        $sql_them = "INSERT INTO tbl_phanhoi(id_sv,chude,theloai,mucdo,ykien,file,noidung,tomtat,thoigian,hoanthanh,trangthai,phongban,lidohuy,goigam) VALUES('".$id_sv."','".$chude."','".$theloai."','Đợi xác nhận','".$ykien."','".$file_time."','".$noidung."','".$tomtat."','".$now."','Chưa hoàn thành',0,0,0,0)";
        ...
        if($file != ''){
            move_uploaded_file($file_tmp,'images/file/'.$file_time);
            $sql_update = "UPDATE tbl_phanhoi SET chude = '".$chude."',theloai = '".$theloai."', ykien = '".$ykien."', file = '".$file_time."', noidung = '".$noidung."', tomtat = '".$tomtat."' WHERE id_phanhoi = '$_GET[id]'";
            ...
            $sql_update = "UPDATE tbl_phanhoi SET chude = '".$chude."',theloai = '".$theloai."', ykien = '".$ykien."', noidung = '".$noidung."', tomtat = '".$tomtat."' WHERE id_phanhoi = '$_GET[id]'";
        }
