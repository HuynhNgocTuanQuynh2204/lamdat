    ...
    <div class="text-center">
        ...
        <div class="container">
            ...
            while ($row = mysqli_fetch_array($query_lietke_phanhoi)) {
              $i++;
              if ($row['trangthai'] != 0 && $row['trangthai'] != 1 && $row['trangthai'] != 5 && $row['phongban'] == 5) {
            ?>
                        <tr>
                            <td><?php echo $i ?></td>
                   ...
                   if ($row['trangthai'] == 0) {
                    ...
                    ?>
                            ...
                            <td>
                                <a href="index.php?quanly=chitietphanhoisp&id=<?php echo $row['id_phanhoi'] ?>"
                                    class="btn btn-info">Xem chi tiếtt</a>
                                <br>
                                <?php
                                    if ($row['trangthai'] ==2 ) {
                                    ?>
                                <a href="index.php?quanly=giaiquyetphanhoisp&id=<?php echo $row['id_phanhoi'] ?>"
                                    class="btn btn-success">Giải quyết</a>
                                <?php
                                    }else if($row['trangthai'] == 3){?>
                                <a href="index.php?quanly=giaiquyetphanhoispxong&id=<?php echo $row['id_phanhoi'] ?>"
